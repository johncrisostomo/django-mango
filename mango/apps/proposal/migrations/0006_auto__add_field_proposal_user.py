...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('proposal_proposal', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='proposals', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proposal.user'
        db.delete_column('proposal_proposal', 'user_id')
