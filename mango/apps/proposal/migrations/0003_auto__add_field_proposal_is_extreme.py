...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proposal.is_extreme'
        db.add_column('proposal_proposal', 'is_extreme',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proposal.is_extreme'
        db.delete_column('proposal_proposal', 'is_extreme')
